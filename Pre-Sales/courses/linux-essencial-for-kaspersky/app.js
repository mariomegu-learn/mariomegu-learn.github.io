...
const moduleContent = {
  "module-1": {
    ...
    sections: [
      { title: "Linux en el contexto Kaspersky", body: "Linux funciona como plataforma base para servidores y endpoints donde se instalan componentes empresariales. En escenarios Kaspersky, el equipo debe validar sistema operativo, distribución, arquitectura, DNS, usuarios, permisos, servicios, rutas y paquetes antes de ejecutar actividades de implementación o soporte." },
